package com.bcafinance.itdp.mobilesurvey.fragmentRM;
...
public class ProfileFragmentRM extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_profile_rm, container, false);
